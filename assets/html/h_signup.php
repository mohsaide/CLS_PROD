      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li><a href="h_login.php">Login</a></li>
            <li>Sign up</li>   
          </ol>
        </div>
      </nav> 
              ...
              <form>
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Fname" class="form-control" id="first_name" name="first_name" required>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Lname" id="last_name" name="last_name" required>
                      </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input type="date" class="form-control" placeholder="Date of birth" id="DOB"  name="DOB" onkeydown="return false" required>
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="phone" placeholder="123 456 7890" name="phone" pattern="[0-9]{3} [0-9]{3} [0-9]{4}" required>
                  </div>
