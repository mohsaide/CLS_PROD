          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <form method="POST" id='signin_from'>    
              ...
              <div class="d-flex justify-content-between align-items-center">
                <a href="../html/h_signup.php#breadcrumbs" class="text-body form-link">Don't have an account?</a>
                <a href="../html/h_reset.php" class="text-body form-link">Forgot password?</a>
              </div>
